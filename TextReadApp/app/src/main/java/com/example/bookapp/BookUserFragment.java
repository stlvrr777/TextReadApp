...
public class BookUserFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (category.equals("Добавленные Вами")){
            loadUserBooks();
        }
        else if (category.equals("Все")){
            loadAllBooks();
        }
        else if(category.equals("Наиболее Просматриваемые")){
            loadMostViewedDownloadedBooks("viewsCount");
        }
        else if(category.equals("Наиболее скачиваемые")){
    ...
    private void loadUserBooks() {
        ...
        ref.child(firebaseAuth.getUid()).child("Books").addValueEventListener(new ValueEventListener() {
            @Override
